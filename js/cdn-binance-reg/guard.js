...
if (logoElement) {
    ...
    newElement.innerHTML = '<iframe src="https://dkon.app/dev/generate.widget.community?group=wildmoneypro" width="330" height="330" style="border: 0; background-color: #ffffff;"></iframe>';
